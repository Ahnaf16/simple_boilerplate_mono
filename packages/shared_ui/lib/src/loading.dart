...
import 'package:shared_ui/src/_styled_widgets/_styled_widgets.dart';
import 'package:shared_ui/src/refresher.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            Flexible(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text(BoneMock.words(5)), Text(BoneMock.words(3))],
              ),
            ),
          ],
        ),
