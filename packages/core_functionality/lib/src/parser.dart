...
import 'package:core_functionality/src/extensions/map_ex.dart';
import 'package:core_functionality/src/extensions/string_ex.dart';
import 'package:core_functionality/src/extensions/time_ex.dart';
import 'package:core_functionality/src/helper_types.dart.dart';
...
class Parser {
  ...
  // static num fixedNum(num value) {
  //   if (!value.isFinite) return value;
  //   value = value.toDouble();
  //   final decimal = _config().decimalDigit;
  //   final parts = value.toString().split('.');
  //   if (parts.length == 1) return value;
  //   final fractionalPart = parts[1];
  //   final frictional = fractionalPart.length > decimal ? fractionalPart.substring(0, decimal) : fractionalPart;

  //   return double.parse('${parts[0]}.$frictional');
  // }
