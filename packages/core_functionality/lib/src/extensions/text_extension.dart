...
extension TextStyleExtensions on TextStyle {
  ...
  TextStyle get primary => copyWith(color: AppTheme.primary);
  TextStyle get secondary => copyWith(color: AppTheme.secondary);
  TextStyle get error => copyWith(color: AppTheme.error);
  TextStyle get success => copyWith(color: AppTheme.success);
  TextStyle get info => copyWith(color: AppTheme.info);
  TextStyle get warning => copyWith(color: AppTheme.warning);
