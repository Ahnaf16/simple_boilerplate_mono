...
///
/// Built on 2025-08-11 at 12:26 UTC
...
import 'translations_bn.g.dart' deferred as l_bn;
...
enum AppLocale with BaseAppLocale<AppLocale, Tr> {
  en(languageCode: 'en'),
  bn(languageCode: 'bn');
  ...
  Future<Tr> build({
    ...
    switch (this) {
      case AppLocale.en:
        return TrEn(overrides: overrides, cardinalResolver: cardinalResolver, ordinalResolver: ordinalResolver);
      case AppLocale.bn:
        await l_bn.loadLibrary();
        return l_bn.TrBn(overrides: overrides, cardinalResolver: cardinalResolver, ordinalResolver: ordinalResolver);
    }
  }

  @override
  Tr buildSync({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver}) {
    switch (this) {
      case AppLocale.en:
        return TrEn(overrides: overrides, cardinalResolver: cardinalResolver, ordinalResolver: ordinalResolver);
      case AppLocale.bn:
  ...
  Tr get translations => LocaleSettings.instance.getTranslations(this);
}
...
Tr get t => LocaleSettings.instance.currentTranslations;
...
///
/// Step 2:
/// final t = Tr.of(context); // Get t variable.
/// String a = t.someKey.anotherKey; // Use t variable.
/// String b = t['someKey.anotherKey']; // Only for edge cases!
class TranslationProvider extends BaseTranslationProvider<AppLocale, Tr> {
  TranslationProvider({required super.child}) : super(settings: LocaleSettings.instance);

  static InheritedLocaleData<AppLocale, Tr> of(BuildContext context) => InheritedLocaleData.of<AppLocale, Tr>(context);
}
...
extension BuildContextTranslationsExtension on BuildContext {
  Tr get t => TranslationProvider.of(this).translations;
}

/// Manages all translation instances and the current locale
class LocaleSettings extends BaseFlutterLocaleSettings<AppLocale, Tr> {
...
class AppLocaleUtils extends BaseAppLocaleUtils<AppLocale, Tr> {
