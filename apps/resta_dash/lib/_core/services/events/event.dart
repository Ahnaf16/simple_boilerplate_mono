...
class EvBus {
  ...
  //! other events
  void fireAppStateEv(String? eventKey) {
    _throttler(() {
      cat('AppStateEvent fired: $eventKey');
      _eventBus.fire(AppStateEvent(eventKey));
    }, immediateCall: true);
  }

  Stream<AppStateEvent> onAppStateEvent() => onEvent<AppStateEvent>();
}
